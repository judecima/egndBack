...
var createProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res) {
    var _req$body, nombre, categoria, precio, imgUrl, newProducto, productSave;

    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _req$body = req.body, nombre = _req$body.nombre, categoria = _req$body.categoria, precio = _req$body.precio, imgUrl = _req$body.imgUrl;
            newProducto = (0, _products["default"])({
              nombre: nombre,
              categoria: categoria,
              precio: precio,
              imgUrl: imgUrl
    ...
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            productoEliminado = _context5.sent;
            res.status(204).json();
